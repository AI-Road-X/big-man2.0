var EMPLOYEE_TYPES = { MANAGER: '店长', SALESPERSON: '销售员', MECHANIC: '维修工', DRIVER: '司机' };
...
function generateJobCandidates(count) {
  var types = [EMPLOYEE_TYPES.MANAGER, EMPLOYEE_TYPES.SALESPERSON, EMPLOYEE_TYPES.MECHANIC, EMPLOYEE_TYPES.DRIVER];
  var candidates = [];
